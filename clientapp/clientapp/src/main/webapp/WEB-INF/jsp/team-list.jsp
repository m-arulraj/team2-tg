	...
	<div class="main-body-wrapper">
		...
		<div class="mid-wrapper">
			<div class="form-container">
				...
				<a href="" id="register-team" onclick ="registerTeam()">Register Team</a>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		...
		function setContests(allTeam) {
			...
			allTeam.forEach(function(team) {
				elements.innerHTML += "<tr><td><a href='/contest/team?cId="
						+ id + "&tId=" + team.id + "'>" + team.teamName + "("
						+ team.introducedOn + ")</a></td><td>" + ""
						+ "</td><td><a href='/teamplayer?tid="
						+ team.id
						+ "'>"
						+"View Players"
						+ "</a></td><td>" + ""
						+ "</td><td><a href='/teamupdate?tId="
						+ team.id +"&cId="
						+ id 
						+ "'>"
						+"Update Team"
		...
		element = document.getElementById("register-team").href="/team/creation?id="+id;
		/* element.innerHTML +="<a href='/team/creation?id="
			+ id + "'>" 
			+"Register Team</a>" */
		}
	</script>
