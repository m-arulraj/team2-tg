  ...
  <div class="mid-wrapper">
     ...
     <div class="form-container">
        <form method="post" action="/signup"  ">
          ...
          <select id="role">
            <option value="ROLE_TEAM_MANAGER">ROLE_TEAM_MANAGER</option>
            <option value="ROLE_CONTEST_OWNER">ROLE_CONTEST_OWNER</option>
             <option value="ROLE_SCOREBOARD_MANAGER">ROLE_SCOREBOARD_MANAGER</option>
  ...
  /*   function submission(event){
    	...
    	console.log(userRoleJson);
    	 var xhttp = new XMLHttpRequest();
		  ...
		  xhttp.send(JSON.stringify(userRole));   	
    ...
    if(!(e.charCode>=48&&e.charCode<=57)){
     ...
     /*  function submission(event){
    	   event.preventDefault();
    		  ...
    		  let user = {name:elements[0].value,email:elements[1].value, mobile:elements[2].value,dob:elements[3].value,address:elements[4].value,password:elements[6].value};
    		  let userRole={role:elements[5].value,user};
    		  /*  if(valueCheck()){
